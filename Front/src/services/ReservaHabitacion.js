...
const baseUrl = "http://localhost:3001/api/reservashabitacion";
...
export const agregarProductoReservaHabitacion = async (id_reserva, productoData) => {
  try {
...
export const updateProductoReservaHabitacion = async (id_reserva, productoData) => {
  try {
    const response = await axios.put(
