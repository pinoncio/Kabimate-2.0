          ...
          <table className="tabla-reservas">
            ...
            <tbody>
              {currentReservas.map((reserva, i) => (
                <tr key={reserva.ID_RESERVA_HABITACION}>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              {/* Nombre del Huésped */}
              <div className="mb-2">
                <strong>Nombre del Huésped</strong>
              </div>
              ...
              <div className="mb-2">
                <strong>Apellido del Huésped</strong>
              </div>
              <div className="d-flex">
                <input
                  type="text"
              ...
              {/* Edad del Huésped */}
              <div className="mb-2">
                <strong>Edad del Huésped</strong>
              </div>
              <input
                type="number"
                className="form-control"
              ...
              <div className="mb-2">
                <strong>Dirección del Huésped</strong>
              </div>
              <input
                type="text"
                className="form-control"
              ...
              <div className="mb-2">
                <strong>Teléfono del Huésped</strong>
              </div>
              <input
                type="text"
                className="form-control"
...
export default ListaHabitacionReservas;
