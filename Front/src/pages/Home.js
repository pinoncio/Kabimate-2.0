...
const Home = () => {
    return (
        <div className="home-wrapper">
            ...
            <p className="home-subtitle">La herramienta ideal para practicar la administración de Hotel y de cabañas.</p>
            ...
            <section className="description">
                ...
                <p>Con nuestra plataforma, podrás administrar tanto <strong>Hotel</strong> como <strong>cabañas</strong>, eligiendo la vista que mejor se adapte a tus necesidades mediante los botones en el encabezado.</p>
                <p>Para una mejor experiencia de usuario, simplemente selecciona entre los botones de <strong>Hotel</strong> o <strong>Cabañas</strong> en la parte superior de la página. Esto cambiará la vista y funcionalidades de la plataforma según tu elección.</p>
            </section>
            ...
            <section className="instructions">
                ...
                <ul>
                    <li>Seleccionar entre las opciones de <strong>Hotel</strong> o <strong>Cabañas</strong> en la parte superior de la página para decidir qué tipo de alojamiento deseas administrar y practicar.</li>
                    <li>Gestionar reservas tanto de Hotel como de Cabañas.</li>
                    <li>Acceder a tu historial de reservas y administrarlas fácilmente.</li>
                    <li>Administrar los detalles del Hotel y cabañas que gestionas, como precios, disponibilidad y servicios.</li>
                </ul>
            </section>
