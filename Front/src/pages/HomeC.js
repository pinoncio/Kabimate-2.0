    ...
    return (
      <div className="homec-wrapper">
        ...
        <div className="instructions-cabana">
          <p>Para comenzar, selecciona entre las opciones de <strong>Cabañas</strong> en la parte superior de la página. Esto te llevará a una vista dedicada para gestionar tus cabañas.</p>
          <p>Luego, podrás gestionar reservas, ver tu historial, y administrar las cabañas desde allí. Explora las diferentes funcionalidades y encuentra lo que necesitas.</p>
        </div>
        ...
        <div className="cards-container-cabana">
          <div className="category-description-cabana">
            ...
            <h2>Cabañas</h2>
            <ul>
              <li>Aquí puedes ver la lista completa de todas las cabañas disponibles en el sistema.</li>
              <li>Consulta el estado de cada cabaña: disponible, ocupada o en mantenimiento.</li>
            </ul>
          </div>
          ...
          <div className="category-description-cabana">
            <i className="fa fa-house-user"></i> {/* Icono de Casa para Cabañas */}
