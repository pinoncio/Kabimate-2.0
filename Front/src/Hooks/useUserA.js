...
import { getUsersA, createUserA, updateUserA, activateUserA } from '../services/userA';
...
const useUserA = () => {
  ...
  const getAllUsers = async () => {
    try {
      ...
      const filteredUsers = userData.filter(user => user.ID_ROL_USUARIO === 1);
  ...
  const openModal = (op, id_usuario = '', nombre1_usuario = '', nombre2_usuario = '', 
    ...
    id_institucion_usuario = '', id_rol_usuario = '1') => {
